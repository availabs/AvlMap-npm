...
var CursorClick = /*#__PURE__*/function (_Component) {
  _inherits(CursorClick, _Component);

  var _super = _createSuper(CursorClick);

  function CursorClick() {
    _classCallCheck(this, CursorClick);

    return _super.apply(this, arguments);
  }

  _createClass(CursorClick, [{
    key: "render",
...
_defineProperty(CursorClick, "propTypes", {
  /** Set the height of the icon, ex. '16px' */
  height: _propTypes["default"].string
});

_defineProperty(CursorClick, "defaultProps", {
  height: '16px',
