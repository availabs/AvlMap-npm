...
var SquareSelect = /*#__PURE__*/function (_Component) {
  _inherits(SquareSelect, _Component);

  var _super = _createSuper(SquareSelect);

  function SquareSelect() {
    _classCallCheck(this, SquareSelect);

    return _super.apply(this, arguments);
  }

  _createClass(SquareSelect, [{
    key: "render",
...
_defineProperty(SquareSelect, "propTypes", {
  /** Set the height of the icon, ex. '16px' */
  height: _propTypes["default"].string
});

_defineProperty(SquareSelect, "defaultProps", {
  height: '16px',
