...
var FilterFunnel = /*#__PURE__*/function (_Component) {
  _inherits(FilterFunnel, _Component);

  var _super = _createSuper(FilterFunnel);

  function FilterFunnel() {
    _classCallCheck(this, FilterFunnel);

    return _super.apply(this, arguments);
  }

  _createClass(FilterFunnel, [{
    key: "render",
...
_defineProperty(FilterFunnel, "propTypes", {
  /** Set the height of the icon, ex. '16px' */
  height: _propTypes["default"].string
});

_defineProperty(FilterFunnel, "defaultProps", {
  height: '16px',
