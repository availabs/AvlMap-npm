...
var VertDots = /*#__PURE__*/function (_Component) {
  _inherits(VertDots, _Component);

  var _super = _createSuper(VertDots);

  function VertDots() {
    _classCallCheck(this, VertDots);

    return _super.apply(this, arguments);
  }

  _createClass(VertDots, [{
    key: "render",
...
_defineProperty(VertDots, "propTypes", {
  /** Set the height of the icon, ex. '16px' */
  height: _propTypes["default"].string
});

_defineProperty(VertDots, "defaultProps", {
  height: '16px',
